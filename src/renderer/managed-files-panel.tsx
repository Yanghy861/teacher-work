...
type MaterialContextMenuTarget = Exclude<MaterialContextMenu, null>
...
interface MaterialContextMenuProps {
  readonly menu: MaterialContextMenuTarget
  readonly folder: MaterialFolder | null
  readonly file: ManagedFileRecord | null
  ...
  readonly onDeleteFolder: (folder: MaterialFolder) => void | Promise<void>
  readonly onOpenFile: (file: ManagedFileRecord) => void
  readonly onShowInFolder: (file: ManagedFileRecord) => void
...
export function FolderBranch(props: FolderBranchProps): React.JSX.Element {
